    ...
    ColumnLayout {
        ...
        Item {
            ...
            Charts.LineChart {
                ...
                valueSources: [
                Charts.ModelSource { roleName: "temperature"; model: hourlyModel }
                ]
                ...
                colorSource: Charts.SingleValueSource { value: Kirigami.Theme.buttonTextColor }
                fillColorSource: Charts.ColorGradientSource {
                    baseColor: Kirigami.Theme.focusColor
                    itemCount: 3
                }
            ...
            ChartsControls.AxisLabels {
                ...
                delegate: PlasmaComponents.Label {
                    ...
                    text: "<b>" + hourlyModel.get(ChartsControls.AxisLabels.label).time.split("T")[0].split("-")[2] + "</b>"
                }
                source: Charts.ChartAxisSource {
                    chart: lineChart;
            ...
            ListView {
                ...
                highlight: Rectangle {
                    color: Kirigami.Theme.complementaryFocusColor
                    Layout.fillWidth:true
                    radius: 2
                }
                focus: true
